...
UNIT = 100  # Number of pixels for one grid
HEIGHT = 9  # Number of grids vertically
WIDTH = 9  # Number of grids horizontally
TRANSITION_PROB = 1
POSSIBLE_ACTIONS = [0, 1, 2, 3]  # up, down, left, right
ACTIONS = [(-1, 0), (1, 0), (0, -1), (0, 1)]  # Changes of position according to actions
REWARDS = []
...
class Env:
    def __init__(self):
        ...
        self.reward[4][4] = 1  # reward 1 for circle
        self.reward[3][4] = -1  # reward -1 for triangle
